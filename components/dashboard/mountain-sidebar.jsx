...
export function MountainSidebar() {
  ...
  return (
    <>
        ...
        <AnimatePresence>
          {isOpen && (
            <>
              ...
              />
              <motion.div
                className="fixed top-0 left-0 bottom-0 w-[280px] z-50 bg-white border-r"
                ...
                <div className="flex flex-col h-full">
                  ...
                  <div className="flex-1 overflow-y-auto py-4">
                    ...
                    <nav className="space-y-1 px-2">
                      <Link
                        href="/dashboard/help"
                        className="flex items-center gap-3 px-3 py-2 rounded-md text-sm transition-colors text-gray-700 hover:bg-gray-50"
                        onClick={() => isMobile && setIsOpen(false)}
                      >
      ...
      {!isMobile && (
        <motion.div
          className="h-screen sticky top-0 border-r bg-white flex flex-col"
          ...
          <div className="relative h-48 overflow-hidden">
            ...
            <div className="absolute top-4 left-4 right-4 flex items-center justify-between z-20">
              <Link href="/" className="flex items-center gap-2 font-bold text-xl text-white">
                {!isCollapsed && <span>Retreat</span>} <Mountain className="h-6 w-6" />
              </Link>
              <Button
                variant="ghost"
                size="icon"
                className="bg-white/20 backdrop-blur-sm rounded-full text-white hover:bg-white/30"
            ...
            <nav className="space-y-1 px-2">
              {getMenuItems().map((item) => (
                <Link
                  ...
                  href={item.path}
                  className={`flex items-center gap-3 px-3 py-2 rounded-md text-sm transition-colors ${
                    isActive(item.path) ? "bg-gray-100 text-black font-medium" : "text-gray-700 hover:bg-gray-50"
